...
export function buildQuizPrompt(input: BuildQuizPromptInput): string {
  ...
  return [
    ...
    '{ "questions": [ ... ] }',
    "Each question object must use exactly these keys and no others:",
    '{ "id": "q1", "prompt": "Question text", "type": "single", "options": [{ "id": "o1", "label": "Option text" }, { "id": "o2", "label": "Option text" }, { "id": "o3", "label": "Option text" }, { "id": "o4", "label": "Option text" }], "correctOptionIds": ["o1"] }',
    "",
    `Quiz requirements:`,
    `- Generate exactly ${questionCount} questions.`,
    `- Each question must have exactly ${QUIZ_OPTION_COUNT} options.`,
    '- Every question object must include exactly: "id", "prompt", "type", "options", "correctOptionIds".',
    '- Every option object must include exactly: "id", "label".',
    '- "type" must always be either "single" or "multiple".',
    '- "correctOptionIds" must always be an array, even for single-answer questions.',
    ...
    '- Do not use the keys "question", "text", "correctOptionId", "correct_option_id", or "correct_option_ids".',
